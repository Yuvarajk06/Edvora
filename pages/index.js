...
class Home extends React.Component {
  ...
  render() {
    ...
    const listItems = [
      <Container borderRadius="25px" marginTop="30px" bg="lightgray.50" maxW="90%" height="270px" boxShadow="md" >
  ...
  return (
    <div className={styles.container}>
      ...
      <Container  borderRadius="25px" bg="lightgray.50" maxW="90%" height="270px" boxShadow="md" >
        <Textarea
          padding="20px"
          focusBorderColor="none"
          maxW="100%"
